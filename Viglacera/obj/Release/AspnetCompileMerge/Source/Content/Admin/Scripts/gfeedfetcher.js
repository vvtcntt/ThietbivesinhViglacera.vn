...
var gfeedfetcher_loading_image = "/Extensions/Js/rssReader/indicator.gif" //Full URL to "loading" image. No need to config after this line!!
...
gfeedfetcher.prototype.setentrycontainer = function(containerstr, classname) {  //set element that should wrap around each RSS entry item
    this.itemcontainer = "<" + containerstr.toLowerCase() + " class='" + classname + "'>"
}

gfeedfetcher.prototype.init = function() {
    this.feedsfetched = 0 //reset number of feeds fetched to 0 (in case init() is called more than once)
    this.feeds = [] //reset feeds[] array to empty (in case init() is called more than once)
    this.feedcontainer.innerHTML = '<p><img src="' + gfeedfetcher_loading_image + '" /> Đang tải dữ liệu...</p>'
    var displayer = this
