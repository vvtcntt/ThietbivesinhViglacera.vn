    ...
    $.iModal.modal = {
        ...
        displayModal: function (data) {
            ...
            if (data.indexOf('ModalTitle') > 0 && data.indexOf('ModalContent') > 0) {
                ...
                modalContent += '<div id="ModalContentContainer"><div class="ModalTitle">' + this.options.title + '</div><div class="ModalContent" style="height:' + this.options.height + 'px' + '">' + data + '</div>' + buttons + '</div>';
            }
        ...
        generateModal: function () {
            ...
            if (this.options.type == 'ajax') {
                ...
                //                });
                var str = '';
                str += '<object height="344" width="425">';
                str += '<param value="' + this.options.url + '" name="movie">'
                str += '<param value="true" name="allowFullScreen"><param value="always" name="allowscriptaccess">';
                str += '<embed height="344" width="425" allowfullscreen="true" allowscriptaccess="always" type="application/x-shockwave-flash" src="' + this.options.url.replace('.com/v//', '.com/v/') + '"></object>';
                modal.displayModal(str);
            }
            else if (this.options.type == 'iframe') {
                modal = this;
                var str = '<iframe scrolling="no" frameborder="0" style="margin: 0 auto; width: 100%; height: 100%; border: none;" src="' + this.options.url + '"></iframe>';
                modal.displayModal(str);
            }
            else {
                ...
                str += '<param value="' + this.options.url + '" name="movie">'
                str += '<param value="true" name="allowFullScreen"><param value="always" name="allowscriptaccess">';
                str += '<embed height="344" width="425" allowfullscreen="true" allowscriptaccess="always" type="application/x-shockwave-flash" src="' + this.options.url + '"></object>';
                modal.displayModal(str);
            }
        },
...
function ModalBox(title, content){
	var str = '<div class="ModalTitle">'+title+'</div><div class="ModalContent">111111111</div><div class="ModalButtonRow"></div>';
	$.iModal({ data: str });
}
