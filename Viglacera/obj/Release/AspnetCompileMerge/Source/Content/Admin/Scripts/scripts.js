var App = function () {
    ...
    var handleDashboardCharts = function () {
        ...
        var plot = $.plot(jQuery("#site_statistics"), [{
            data: pageviews,
            label: "Unique Visits"
        }, {
            data: visitors,
        ...
        var plot = $.plot(jQuery("#load_statistics"), [getRandomData()], options);
    ...
    var handleCharts = function () {
        ...
        function chart4() {
            ...
            var updateInterval = 30;
            var plot = $.plot(jQuery("#chart_4"), [getRandomData()], options);
