...
namespace Viglacera.Controllers.Admin.support
{
    public class supportController : Controller
    {
        ...
        public ActionResult UpdateSupport(string id, string Active, string Ord)
        {
            if (ClsCheckRole.CheckQuyen(15, 2, int.Parse(Request.Cookies["Username"].Values["UserID"])) == true)
            {

                int ids = int.Parse(id);
                var tblsupport = db.tblSupports.Find(ids);
                tblsupport.Active = bool.Parse(Active);
                tblsupport.Ord = int.Parse(Ord);
                db.SaveChanges();
        ...
        public ActionResult Create()
        {
            ...
            {
                var pro = db.tblSupports.OrderByDescending(p => p.Ord).ToList();
                if (pro.Count > 0)
